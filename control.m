%% Processing control files and getting averages
%% Memory allocation
Parea_av = zeros(numel(control_files),1);
Pareastd_av = zeros(numel(control_files),1);
Pmean_av = zeros(numel(control_files),1);
Pmeanstd_av = zeros(numel(control_files),1);
Pmax_av = zeros(numel(control_files),1);
Pmaxstd_av = zeros(numel(control_files),1);
Pmin_av = zeros(numel(control_files),1);
Pminstd_av = zeros(numel(control_files),1);
Pareatotal_av = zeros(numel(control_files),1);
Pn = zeros(numel(control_files),1);

Carea_av = zeros(numel(control_files),1);
Careastd_av = zeros(numel(control_files),1);
Cmean_av = zeros(numel(control_files),1);
Cmeanstd_av = zeros(numel(control_files),1);
Cmax_av = zeros(numel(control_files),1);
Cmaxstd_av = zeros(numel(control_files),1);
Cmin_av = zeros(numel(control_files),1);
Cminstd_av = zeros(numel(control_files),1);
Cn = zeros(numel(control_files),1);

Marea_av = zeros(numel(control_files),1);
Mareastd_av = zeros(numel(control_files),1);
Mmean_av = zeros(numel(control_files),1);
Mmeanstd_av = zeros(numel(control_files),1);
Mmax_av = zeros(numel(control_files),1);
Mmaxstd_av = zeros(numel(control_files),1);
Mmin_av = zeros(numel(control_files),1);
Mminstd_av = zeros(numel(control_files),1);
Mn = zeros(numel(control_files),1);
tolerance_achieved = zeros(numel(control_files),1);
Mmean_nonpuncta = zeros(numel(control_files),1);

relative_puncta_area2 = zeros(numel(control_files),1);
...
for i=1:numel(control_files)
    ...
    if  strcmp(usemask, 'Yes')
        ...
        maskpath = [tif8_dir_control, '/', num2str(i), '/handCorrection.png'];
